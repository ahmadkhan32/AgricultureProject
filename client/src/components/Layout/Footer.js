...
const Footer = () => {
  ...
  const services = [
    { name: 'Producer Support', href: '/services' },
    { name: 'Training Programs', href: '/services' },
    { name: 'Assistance Programs', href: '/services' },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              Chamber of Agriculture, Livestock, and Fisheries of the Comoros. 
              Promoting sustainable agricultural practices and supporting local producers.
            </p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-gray-400 text-sm">
              © {currentYear} UCAEP. All rights reserved.
            </p>
